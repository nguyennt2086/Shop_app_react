...
import {StyleSheet, Text, TouchableOpacity, View, FlatList, ScrollView, TextInput, Modal} from "react-native";
import Ionicons from "react-native-vector-icons/Ionicons";
import AntDesign from "react-native-vector-icons/AntDesign";

import { useDispatch, useSelector } from "react-redux";
import { useState, useEffect } from "react";
import { fetchAllCmts, writeAnswer, updateCmt } from "../redux/actions/tagAction";
...
const Cmt = ({params,id,}) =>{
    ...
    return(
        <View style={styles.container}>
            <FlatList 
            data={db.tag}
            renderItem={({item})=><ItemComponent item={item} id={id}/> }
...
const ItemComponent = ({item,id,}) =>{
    ...
    const [cmt, setCmt] = useState("@"+item.id+" ");
